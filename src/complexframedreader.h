...
/**
 * Reads data in a customizable complex framed format.
 */
class ComplexFramedReader : public AbstractReader
{
    Q_OBJECT

public:
    explicit ComplexFramedReader(QIODevice* device, QObject *parent = 0);
...
private slots:
    ...
    void onSizeFieldChanged(ComplexFramedReaderSettings::SizeFieldType, unsigned);
};

#endif // COMPLEXFRAMEDREADER_H
